...
**Data:** Marco de 2026
**Projecto:** Eat Out Adviser - Aplicacao full-stack com foco em acessibilidade para recomendacao de restaurantes
**Ambientes:** MacBook Air M1 16GB (desenvolvimento) | Proxmox em Intel N5105 16GB (producao/self-hosting)
...
**Modelo recomendado:** Claude Sonnet 4.6 (melhor relacao custo/performance para producao)
**Modelo premium:** Claude Opus 4.5 (para tarefas que exijam raciocinio avancado)
